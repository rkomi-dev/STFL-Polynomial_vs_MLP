...
for i = 1:length(neuron_range)
    ...
    for f = 1:k
        ...
        net_fold = train(net_fold, X_train_fold, y_train_fold, 'useParallel', 'yes');
...
net_finale.divideParam.trainRatio = 0.85;
net_finale.divideParam.valRatio   = 0.15;
net_finale.divideParam.testRatio  = 0; 
net_finale.trainParam.max_fail = 10;
