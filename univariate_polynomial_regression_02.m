...
phi_V_quarto = [ones(n_t, 1), w_avg_test, w_avg_test.^2, w_avg_test.^3, w_avg_test.^4];
...
phi_V_quinto = [ones(n_t, 1), w_avg_test, w_avg_test.^2, w_avg_test.^3, w_avg_test.^4, w_avg_test.^5];
load_cap_V_quinto = phi_V_quinto * thetaLS_quinto;
epsilon_V_quinto = data_test.LOAD - load_cap_V_quinto;
...
RMSE_quadratico_test = sqrt(SSR_V_quadratico / n_t);
RMSE_cubico_train = sqrt(SSR_cubico / n);
RMSE_cubico_test = sqrt(SSR_V_cubico / n_t);
RMSE_quarto_train = sqrt(SSR_quarto / n);
RMSE_quarto_test = sqrt(SSR_V_quarto / n_t);
RMSE_quinto_train = sqrt(SSR_quinto / n);
RMSE_quinto_test = sqrt(SSR_V_quinto / n_t);

rmse_train_vals = [RMSE_quadratico_train, RMSE_cubico_train, RMSE_quarto_train, RMSE_quinto_train];
rmse_test_vals  = [RMSE_quadratico_test, RMSE_cubico_test, RMSE_quarto_test, RMSE_quinto_test];
